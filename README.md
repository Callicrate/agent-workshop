...
Skills are grouped into plugins by category and exposed through marketplace
definitions for Claude, Copilot, and Codex. Feel free to install whatever looks
useful and ignore the rest.

This public repository contains inspectable skill sources and pre-generated
provider payloads. Installation does not execute repository-maintenance scripts.
